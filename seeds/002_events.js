  ...
  return knex('events').del()
    .then(function() {
      ...
      return knex('events').insert([
        {id: 1, key: uuidv4(), name: 'Money2020', date: '2018-10-25', location: 'Las Vegas, Nevada', description: 'Hackathon in Vegas', event_picture_url: 'https://pbs.twimg.com/profile_images/915954899925467136/MQFzXfTQ_400x400.jpg', website: 'https://www.money2020.com/'},
